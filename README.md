...
* I personally do better in 1-to-2-hour blocks when it comes to solving problems, although zybook lessons I could handle in the 20-30 minutes if required. I also needed to create more structure for when I would post weekly to prevent gaps in my communication. This is especially important professionally and one of my biggest failures/learning points of this course.
...
* I became much more comfortable reading and referencing the cplusplus.com documentation as my primary source when troubleshooting.
...
* Feel free to jump between exercises, they are not necessarily arranged in a natural learning progression.
...
* One of the most useful and my most often ignored lessons from Prof. Knox: Write out what steps you need to accomplish as comments, then go back and code them. If you have a clear understanding of what you’re trying to accomplish it makes the coding much easier. For example, my class projects were a lot easier to code than my Exercism projects because that is where implemented this advice the most. 
...
Hopefully I can apply all of these lessons to help my process work better in the future. 

As I reviewed my posts from this course, I could see where I started to get frustrated, break down, and blame the tools and the way Exercism is set up for my lack of progress. Instead, I should have focused on where I could learn the skills I need for each problem then return to solve it. The real world often provides problems to solve instead of carefully thought out lessons to help you to a solution. Above all, find and ask for help when needed. 
